...
class SelectModal extends StatefulWidget {
  ...
  SelectModal(String path, BluetoothDevice server) {
    this.path = path;
    this.server = server;
  }

  @override
  State<SelectModal> createState() => _SelectModalState(path, server);
}

class _SelectModalState extends State<SelectModal> {
  String path = 'path';
  late BluetoothDevice server;
  _SelectModalState(String path, BluetoothDevice server) {
    this.path = path;
    this.server = server;
  }
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              TextButton(
                onPressed: () {
                  _navigateToPaintingPage(context, modal_value, epoch_value);
                },
                child: Text(
                  'GO TO PAINTING',
